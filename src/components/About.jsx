...
const About = () => {
  return (
    <div name="about" className="h-screen bg-[#ffffff] w-full text-[#a44747]">
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          <div className="sm:text-right text-4xl font-bold text-[#d79999]">
            <p>
              Hi. I'm Sümeyra , nice to meet you. Please take a look around.
            </p>
          </div>
